        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <p>Below are some of the resources that we used throughout this app. Note: 
                    You'll have one challenege where you will be asked to make this page better.</p>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="https://www.pluralsight.com/course/react-js-getting-started"
                        target="_blank">
                    ...
                    <li>
                        <a href="https://reactstrap.github.io/" target="_blank">
                            ReactStrap for Bootstrap Application
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="https://github.com/bmorelli25/interactive-bitcoin-price-chart" 
                        target="_blank">
                            Bitcoin
                        </a>
                    </li>
